...
<template>
    <div class="fixed bottom-4 left-1/2 -translate-x-1/2 !rounded-full glass !border-none p-3 px-6 flex gap-x-4">
        ...
        <NuxtLink to="/">
            <div class="flex items-center font-bold rounded-full group transition-all  p-2 md:p-3 gap-x-2 hover:bg-base-100"
        ...
        <NuxtLink to="/projects"
            class="flex items-center font-bold rounded-full group transition-all  p-2 md:p-3 gap-x-2 hover:bg-base-100"
