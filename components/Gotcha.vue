...
<template>
    ...
    <div class="!bg-warning/10 p-6 pt-16 my-12 rounded-box  relative">
        ...
        <!-- <div class="font-bold mt-6 ">Hint</div> -->
        <div
            class="bg-gradient-to-tl !p-0 !leading-normal !m-0 from-warning via-warning to-warning text-transparent bg-clip-text font-normal-weight ">
            <slot />
        </div>
