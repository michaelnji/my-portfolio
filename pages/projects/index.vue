            ...
            <div class="!h-max p-6 rounded-box bg-base-200 w-full max-w-1/3 sticky top-12 hidden md:block">
                ...
                <div class="mt-12 space-y-2 w-full">
                    <button @click="activeTab = 'featured'"
                        ...
                        class="flex w-full cursor-pointer items-center rounded-full group transition-all  p-2 md:p-3 gap-x-2 hover:bg-base-300">
                ...
                <div class="mt-16">
                    <button class="btn btn-secondary !flex !items-center w-full">
